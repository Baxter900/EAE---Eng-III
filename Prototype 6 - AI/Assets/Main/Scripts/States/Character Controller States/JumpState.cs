...
public class JumpState : CharacterControllerState{
    ...
    protected float moveSpeedWhileJumpingMult = 0.2f;
    ...
    public override void OnFixedUpdate(CharacterControllerDriver driver){
        driver.rb.AddForce(driver.baseMoveSpeed * moveSpeedWhileJumpingMult * driver.moveState.worldInput, ForceMode.Acceleration);
