...
public class CharacterControllerDriver : MonoBehaviour{
    ...
    [SerializeField][Required]
    [Tooltip("This is the rigidbody we affect as the player.")]
    public Rigidbody rb;

    [SerializeField][Required]
    [Tooltip("This is the attack inventory of the player.")]
    ...
    [SerializeField]
    [Tooltip("How long we want to prevent the player from being grounded after jumping.")]
